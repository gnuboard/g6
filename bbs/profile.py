...
async def get_profile(
    ...
    member_profile: Member = db.scalar(
        select(Member).where(Member.mb_id == member_id))
    ...
    mb_datetime = member_profile.mb_datetime if not is_none_datetime(
        member_profile.mb_datetime) else datetime.now()
